...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchUserListings = async () => {
      ...
      const [res1, res2] = await Promise.all([
        axios.get('http://localhost:8080/api/listings/purchases', { headers }),
        axios.get('http://localhost:8080/api/listings/userListings', { headers }),
      ]);
  ...
  return (
    <div>
      ...
      <h1 className='ml-4 text-lg font-medium mb-6'>My Purchases</h1>
      ...
      <h1 className='ml-4 text-lg font-medium mb-6 mt-8'>Listed for sale</h1>
      <div className='grid grid-cols-4 px-24 gap-4'> 
