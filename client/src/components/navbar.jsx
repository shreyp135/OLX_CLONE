    ...
    return (<>
      <div className='flex flex-row justify-between align-middle bg-gray-1'>
        ...
        <div className='flex flex-row justify-center items-center'>
          <a href="/newListing">
          <img src="https://res.cloudinary.com/dahhchuj8/image/upload/v1724006509/S1creenshot_2024-08-18_235928_shu26k.png" alt="" className='w-20 mr-4 hover:shadow-md hover:duration-200 rounded-3xl'/>
          </a>
        </div>
